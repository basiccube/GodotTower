...
func destroy():
	...
	var pizzaslice1 = utils.instance_create(global_position.x + 32, global_position.y + 32, "res://Objects/Collectibles/obj_pizzaslice.tscn")
	pizzaslice1.speed = 2
	var pizzaslice2 = utils.instance_create(global_position.x + 32, global_position.y + 32, "res://Objects/Collectibles/obj_pizzaslice.tscn")
	pizzaslice2.speed = -2
